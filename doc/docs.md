...
* [Structs](structs.md)
    * [Heap structs](structs.md#heap-structs)
    * [Default field values](structs.md#default-field-values)
    * [Required fields](structs.md#required-fields)
    * [Short struct literal syntax](structs.md#short-struct-literal-syntax)
    * [Struct update syntax](structs.md#struct-update-syntax)
    * [Trailing struct literal arguments](structs.md#trailing-struct-literal-arguments)
    * [Access modifiers](structs.md#access-modifiers)
    * [Anonymous structs](structs.md#anonymous-structs)
    * [[noinit] structs](structs.md#noinit-structs)
    * [Methods](structs.md#methods)
    * [Embedded structs](structs.md#embedded-structs)
* [Unions](unions.md)

</td><td valign=top>

* [Functions 2](functions2.md)
    * [Immutable function args by default](functions2.md#immutable-function-args-by-default)
    * [Mutable arguments](functions2.md#mutable-arguments)
    * [Variable number of arguments](functions2.md#variable-number-of-arguments)
    * [Anonymous & higher-order functions](functions2.md#anonymous--higher-order-functions)
    * [Closures](functions2.md#closures)
    * [Parameter evaluation order](functions2.md#parameter-evaluation-order)
* [References](references.md)
* [Constants](constants.md)
    * [Required module prefix](constants.md#required-module-prefix)
* [Builtin functions](builtin.md)
    * [println](builtin.md#println)
    * [Printing custom types](builtin.md#printing-custom-types)
    * [Dumping expressions at runtime](builtin.md#dumping-expressions-at-runtime)
* [Modules](modules.md)
    * [Create modules](modules.md#create-modules)
    * [init functions](modules.md#init-functions)
...
* [Type Declarations](types.md)
    ...
    * [Enums](types.md#enums)
    * [Function Types](types.md#function-types)
    * [Interfaces](types.md#interfaces)
    * [Sum types](types.md#sum-types)
    * [Option/Result types & error handling](types.md#optionresult-types-and-error-handling)
        * [Handling options/results](types.md#handling-optionsresults)
    * [Custom error types](types.md#custom-error-types)
    * [Generics](types.md#generics)
* [Concurrency](concurrency.md)
    * [Spawning Concurrent Tasks](concurrency.md#spawning-concurrent-tasks)
    * [Channels](concurrency.md#channels)
    * [Shared Objects](concurrency.md#shared-objects)
* [JSON](json.md)
    * [Decoding JSON](json.md#decoding-json)
    * [Encoding JSON](json.md#encoding-json)
* [Testing](testing.md)
    * [Asserts](testing.md#asserts)
    * [Asserts with an extra message](testing.md#asserts-with-an-extra-message)
    * [Asserts that do not abort your program](testing.md#asserts-that-do-not-abort-your-program)
    * [Test files](testing.md#test-files)
    * [Running tests](testing.md#running-tests)
* [Memory management](mem_manage.md)
    * [Control](mem_manage.md#control)
    * [Stack and Heap](mem_manage.md#stack-and-heap)
* [ORM](orm.md)
* [Writing documentation](writing_docs.md)
    * [Newlines in Documentation Comments](writing_docs.md#newlines-in-documentation-comments)

</td><td width=33% valign=top>

* [Tools](tools.md)
    * [v fmt](tools.md#v-fmt)
    * [v shader](tools.md#v-shader)
    * [Profiling](tools.md#profiling)
* [Package Management](package_man.md)
    * [Package commands](package_man.md#package-commands)
    * [Publish package](package_man.md#publish-package)
* [Advanced Topics](advanced.md)
    * [Attributes](advanced.md#attributes)
    * [Conditional compilation](advanced.md#conditional-compilation)
        * [Compile time pseudo variables](advanced.md#compile-time-pseudo-variables)
        * [Compile-time reflection](advanced.md#compile-time-reflection)
        * [Compile time code](advanced.md#compile-time-code)
        * [Environment specific files](advanced.md#environment-specific-files)
    * [Memory-unsafe code](advanced.md#memory-unsafe-code)
    * [Structs with reference fields](advanced.md#structs-with-reference-fields)
    * [sizeof and __offsetof](advanced.md#sizeof-and-__offsetof)
    * [Limited operator overloading](advanced.md#limited-operator-overloading)
    * [Performance tuning](advanced.md#performance-tuning)
    * [Atomics](advanced.md#atomics)
    * [Global Variables](advanced.md#global-variables)
    * [Cross compilation](advanced.md#cross-compilation)
    * [Debugging](advanced.md#debugging)
        * [C Backend binaries Default](advanced.md#c-backend-binaries-default)
        * [Native Backend binaries](advanced.md#native-backend-binaries)
        * [Javascript Backend](advanced.md#javascript-backend)

</td><td valign=top>

* [V and C](advanced.md#v-and-c)
    * [Calling C from V](advanced.md#calling-c-from-v)
    * [Calling V from C](advanced.md#calling-v-from-c)
    * [Passing C compilation flags](advanced.md#passing-c-compilation-flags)
    * [#pkgconfig](advanced.md#pkgconfig)
    * [Including C code](advanced.md#including-c-code)
    * [C types](advanced.md#c-types)
    * [C Declarations](advanced.md#c-declarations)
    * [Export to shared library](advanced.md#export-to-shared-library)
    * [Translating C to V](advanced.md#translating-c-to-v)
    * [Working around C issues](advanced.md#working-around-c-issues)
* [Other V Features](advanced.md#other-v-features)
    * [Inline assembly](advanced.md#inline-assembly)
    * [Hot code reloading](advanced.md#hot-code-reloading)
    * [Cross-platform shell scripts in V](advanced.md#cross-platform-shell-scripts-in-v)
    * [Vsh scripts with no extension](advanced.md#vsh-scripts-with-no-extension)
* [Appendices](appendices.md)
    * [Keywords](appendices.md#appendix-i-keywords)
    * [Operators](appendices.md#appendix-ii-operators)
